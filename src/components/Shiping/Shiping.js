    ...
    return (
        <div className="returnPolicy1" onClick={() => setShiping(false)}>
            <div className="returnBlock1">
                ...
                <h3>Shipping Cost</h3>
                <p>Residents of New Zealand receive Free Australia Post Tracked Express Shipping on all orders over $75.
                    Orders under $75 incur a $4.95 postage fee.</p>

                <h3>Delivery Time</h3>
                <p>Orders are dispatched same day when placed before 1pm AEST. Express Shipping is 2-5 business days for
                    delivery.</p>
                ...
                <h3>Shipping Cost</h3>
                <p>Residents of USA receive Free USPS Tracked Express Shipping on all orders over $75. Orders under $75
                    incur a $4.95 postage fee.</p>

                <h3>Delivery Time</h3>
                <p>Orders are dispatched same day when placed before 1pm AEST. Express Shipping is 3-6 business days for
                    delivery.</p>
                ...
                <h3>Shipping Cost</h3>
                <p>Residents of USA receive Free Canada Post Tracked Express Shipping on all orders over $75. Orders
                    under $75 incur a $4.95 postage fee.</p>
                ...
                <h3>Shipping Cost</h3>
                <p>Residents of USA receive Free Royal Mail Tracked Express Shipping on all orders over $75. Orders
                    under $75 incur a $4.95 postage fee.</p>
                ...
                <p>To complete your return, we require your receipt or proof of purchase. Please include this in your
                    parcel when returning your item.</p>
                <p>We process all returns within one week of receiving your items and we will send you an email with the
                    details of your processed return.</p>
                <p>Please contact us via our Contact Page if you believe your product is damaged or faulty.</p>
                <p>Buyer will be responsible for paying for your own shipping costs for returning your item. Shipping
                    costs are non-refundable.</p>
                <p>If 30 days have gone by since you received your order, unfortunately we cannot offer you a return or
                    exchange.</p>
                ...
                <p>If you haven’t received a refund yet, first check your bank account again. Then contact your credit
                    ...
                    still have not received your refund yet, please contact us via our Contact Page.</p>
            </div>
        </div>
    );
};
